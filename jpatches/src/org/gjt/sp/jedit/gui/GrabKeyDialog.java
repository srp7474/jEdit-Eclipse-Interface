...
public class GrabKeyDialog extends JDialog
{
	...
	@Override
  protected void processKeyEvent(KeyEvent evtP)
	{
    KeyEvent evt = InputHandler.srpIntercept(evtP,this);
    if (evt == null) {
      evtP.consume();
      return;
    }
	...
	private class InputPane extends JTextField
	{
		...
		//{{{ processKeyEvent() method
		@Override
    protected void processKeyEvent(KeyEvent _evtP)
		{
      KeyEvent _evt = InputHandler.srpIntercept(_evtP,this);
      if (_evt == null) {
        _evtP.consume();
        return;
      }
			...
			if (Debug.DUMP_KEY_EVENTS)
			{
        Log.log(Log.DEBUG,GrabKeyDialog.class,"processKeyEvent() key="+key+", _evt="+_evt+'.'/*,new Exception()*/);
			}
	...
	private class ActionHandler implements ActionListener
	{
        ...
        if (Debug.DUMP_KEY_EVENTS)
        {
          Log.log(Log.DEBUG,GrabKeyDialog.class,"-------- clearing mark -----");
        }
			}
		} //}}}
