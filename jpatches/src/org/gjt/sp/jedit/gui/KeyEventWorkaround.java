...
public class KeyEventWorkaround
{
  ...
  public static KeyEvent processKeyEvent(KeyEvent evt)
    ...
    if(Debug.DUMP_KEY_EVENTS) {
      Throwable o = null;
      if ((evt.getKeyChar() == 0x2b) && (evt.getID() == KeyEvent.KEY_TYPED)) o = new Exception();
      Log.log(Log.DEBUG,"KEWx","processKeyEvent.srp scanCode="+(Integer.toString(evt.getExtendedKeyCode(), 16))+" "
      + AbstractInputHandler.toString(evt),o);
    }
    /*KeyEvent evt = InputHandler.srpIntercept(evtP,null);
    if (evt == null) {
      evtP.consume();
      return null;
    }*/
