...
public class KeyEventTranslator
{
    ...
    Log.log(Log.DEBUG,null,"hit key "+evt.getID()+" "+evt.getKeyCode()+" mod="+modifiers+" ch="+evt.getKeyChar());
    ...
    switch(evt.getID())
       ...
       * srp. Aug/30/2016
       */
      /*if ((evt.getKeyLocation() & KeyEvent.KEY_LOCATION_NUMPAD) != 0) {
        if (keyCode == KeyEvent.VK_MINUS) keyCode = KeyEvent.VK_F23;
        if (keyCode == KeyEvent.VK_PLUS)  keyCode = KeyEvent.VK_F24;
      }*/
      if (keyCode == 109) keyCode = KeyEvent.VK_F11;
      if (keyCode == 107) keyCode = KeyEvent.VK_F12;
      /* end of intercept */
      ...
      if ((evt.getKeyCode() == 109) || (evt.getKeyCode() == 107)) return null;
	...
	public static class Key
	{
		...
		*/
		...
		public Key(String modifiers, int key, char input)
		{
			...
			this.input = input;
			hashCode = key + input;
      Log.log(Log.DEBUG,null,"MKE key="+key+" inp="+input+" mod="+modifiers);
		}
